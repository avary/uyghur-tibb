...
const routes = [
  ...
  { path: '/farhiz', name: 'farhiz', component: () => import('../components/BookTopicReader.vue') },
  { path: '/mizaj', name: 'mizaj', component: () => import('../components/BookTopicReader.vue') },
  { path: '/mizaj/quiz', name: 'mizaj-quiz', component: () => import('../views/BookQuizView.vue') },
  { path: '/farhiz/quiz', name: 'farhiz-quiz', component: () => import('../views/BookQuizView.vue') },
