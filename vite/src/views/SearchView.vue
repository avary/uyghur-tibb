...
const records = computed(() => {
  ...
  const topics = MIZAJ_BOOK ? (MIZAJ_BOOK.sections || []).map(section => ({ type:'topic', icon:'📑', title:section.title, text:[MIZAJ_BOOK.title, section.text].join(' '), to:'/mizaj?section='+section.id })) : []
