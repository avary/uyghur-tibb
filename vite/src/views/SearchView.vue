...
import { MIZAJ_BOOK, mizajPages, mizajSections } from '../data/mizaj'
...
const records = computed(() => {
  ...
  const topics = MIZAJ_BOOK ? mizajSections().map(section => ({ type:'topic', icon:'📑', title:section.title, text:[MIZAJ_BOOK.title, section.summary, section.text].join(' '), to:'/mizaj?section='+section.id })) : []
  return [...lessons,...books,...mizaj,...topics,...recipes,...herbs,...questions]
})
